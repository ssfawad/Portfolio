...
export const myProjects = [
  ...
  },
  {
    ...
    desc: "A personal portfolio built with React, Three.js, and Framer Motion, deployed to GitHub Pages via a Vite build pipeline.",
    subdesc:
      "Showcases cloud infrastructure projects across GCP, Azure, and AWS, along with professional certifications. Features an interactive 3D starfield and scroll-driven animations.",
